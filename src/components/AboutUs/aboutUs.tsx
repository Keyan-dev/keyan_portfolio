...
const AboutUs = () => {
    return (
        <div className="row container-fluid about-us-container align-items-center justify-content-center">
            <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1, x: [-300, 0], scale: [0.5, 1] }} transition={{ duration: 0.5 }} className='col-md-12 col-lg-6 justify-content-center align-items-center container-fluid'>
                <img src={aboutUsImage} className='img-fluid about-us-image' />
            </motion.div>
            <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1, x: [500, 0] }} transition={{ duration: 0.5 }} className='col-md-12 col-lg-6 container-fluid justify-content-center align-items-center text-center p-4 text-white'>
